...
}, '3.0.0pr2' ,{requires:['node', 'base'], skinnable:false});
...
YUI.add('dd', function(Y){}, '3.0.0pr2' ,{use:['dd-ddm-base', 'dd-ddm', 'dd-ddm-drop', 'dd-drag', 'dd-proxy', 'dd-constrain', 'dd-plugin', 'dd-drop', 'dd-drop-plugin'], skinnable:false});
