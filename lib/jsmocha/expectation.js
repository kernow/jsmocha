...
Expectation.prototype = {
	...
	times: function(number) {
		this.cardinality = Cardinality.exactly(number);
		return this;
	},
	once: function() {
		this.cardinality = Cardinality.exactly(1);
	...
	twice: function() {
		this.cardinality = Cardinality.exactly(2);
		return this;
	},
	never: function() {
		this.cardinality = Cardinality.exactly(0);
		return this;
	},
	at_least: function(number) {
		this.cardinality = Cardinality.at_least(number);
		return this;
	},
	at_most: function(number) {
		this.cardinality = Cardinality.at_most(number);
		return this;
	},
	passing: function() {
